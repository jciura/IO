...
INSERT INTO classrooms (id, building, number, floor, capacity, has_computers) VALUES (0, 'A1', 101, 1, 20, True),
                                                                                     (1, 'A1', 102, 1, 40, False),
                                                                                     (2, 'A1', 201, 2, 15, True),
                                                                                     (3, 'B2', 102, 1, 30, False),
                                                                                     (4, 'B2', 304, 3, 30, True);

INSERT INTO classroom_software (software_id, classroom_id) VALUES (0, 0),
                                                                  (0, 2),
                                                                  (1, 4),
                                                                  (2, 2),
                                                                  (2, 4);
...
INSERT INTO users (id, first_name, last_name, email, phone_number, role, password) VALUES (0, 'Admin', 'Administer',
                                                                                           ...
                                                                                           '+48123456789', 0,
                                                                                           'root'); -- passwords needs to be hashed!
insert into users (id, first_name, last_name, email, phone_number, role, password)
values (1, 'Lynn', 'Pellissier', 'lpellissier0@marketwatch.com', '+86 410 770 4431', 1,
        '$2a$04$mBYgo57zbHhRpA7CR8u06eooXPpaNDgM9AjG5djL.Oxw2.kTc10vq');
...
values (10, 'Agathe', 'Willox', 'awillox9@sakura.ne.jp', '+86 979 771 3845', 3,
        '$2a$04$ydooWrZ/SgwWf3d7FacBC.Ea1U9UNpCUTfo4VxKcAHtpnXn0PrCEu');
...
values (0, '2025-03-14 01:44:45', 65, 2);
insert into classes (classroom_id, date_time, duration, course_id)
values (1, '2024-07-27 14:40:15', 86, 2);
insert into classes (classroom_id, date_time, duration, course_id)
values (3, '2024-07-24 06:16:06', 83, 4);
insert into classes (classroom_id, date_time, duration, course_id)
values (4, '2024-01-29 14:30:02', 86, 1);
insert into classes (classroom_id, date_time, duration, course_id)
values (1, '2024-11-30 04:42:30', 63, 2);
insert into classes (classroom_id, date_time, duration, course_id)
values (4, '2025-02-02 16:33:41', 71, 1);
insert into classes (classroom_id, date_time, duration, course_id)
values (2, '2024-06-27 15:25:50', 70, 1);
insert into classes (classroom_id, date_time, duration, course_id)
values (2, '2024-05-10 18:45:33', 62, 4);
insert into classes (classroom_id, date_time, duration, course_id)
values (2, '2025-05-27 20:37:27', 84, 1);
insert into classes (classroom_id, date_time, duration, course_id)
values (3, '2025-05-02 10:47:42', 68, 1);
insert into classes (classroom_id, date_time, duration, course_id)
values (0, '2024-08-20 09:45:48', 79, 2);
insert into classes (classroom_id, date_time, duration, course_id)
values (1, '2024-03-07 19:38:47', 89, 0);
insert into classes (classroom_id, date_time, duration, course_id)
values (0, '2024-07-09 15:50:53', 60, 3);
insert into classes (classroom_id, date_time, duration, course_id)
values (0, '2025-04-04 08:46:20', 63, 2);
insert into classes (classroom_id, date_time, duration, course_id)
values (1, '2024-07-30 04:08:11', 73, 1);
insert into classes (classroom_id, date_time, duration, course_id)
values (0, '2024-03-30 01:48:58', 85, 3);
insert into classes (classroom_id, date_time, duration, course_id)
values (3, '2024-07-25 21:38:55', 89, 4);
insert into classes (classroom_id, date_time, duration, course_id)
values (0, '2024-06-01 13:11:25', 73, 3);
insert into classes (classroom_id, date_time, duration, course_id)
values (3, '2025-06-21 10:36:54', 65, 2);
insert into classes (classroom_id, date_time, duration, course_id)
values (4, '2024-07-31 19:57:05', 89, 3);
